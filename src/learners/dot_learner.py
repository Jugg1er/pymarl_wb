...
class DOTLearner:
    def __init__(self, mac, scheme, logger, args):
        ...
        self.params += list(mac.mlp.parameters())
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int, per_weight=None):
        ...
        chosen_ade_vals = th.diagonal(ade_out, dim1=2, dim2=3)
        chosen_ade_vals = chosen_ade_vals[:, :-1]
        ...
        loss = td_loss + self.mac.beta.exp() * ade_loss
